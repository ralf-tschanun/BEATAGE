-- Host can remove participants; independent nominator results reveal mode
-- Paste ONLY this SQL into the Supabase SQL editor

alter table public.contests
  add column if not exists nominator_results_reveal text not null default 'immediate';
...
alter table public.contests
  ...
  check (nominator_results_reveal in ('immediate', 'last_to_first'));

update public.contests
set nominator_results_reveal = 'last_to_first'
where results_reveal = 'last_to_first';

-- ---------------------------------------------------------------------------
-- remove_contest_member: host removes a participant (not self/host)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- advance_results_reveal: nominator phase uses nominator_results_reveal
-- ---------------------------------------------------------------------------
...
-- create_contest / update_contest_settings: persist nominator_results_reveal
