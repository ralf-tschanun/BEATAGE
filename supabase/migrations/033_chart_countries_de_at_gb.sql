-- Allow DE / AT / GB chart countries for birthday contests
-- Paste ONLY this SQL into the Supabase SQL editor

alter table public.contests
  drop constraint if exists contests_chart_country_check;

alter table public.contests
  add constraint contests_chart_country_check
  check (chart_country in ('US', 'DE', 'AT', 'GB'));
