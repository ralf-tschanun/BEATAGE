-- Close nominations when host starts revealing candidates
...
begin
  ...
  -- First reveal ends nominations (no further nominate / edit / withdraw).
...
begin
  ...
  -- Releasing candidates ends nominations (no further nominate / edit / withdraw).
  update public.contests
  set
    nominations_open = false,
    last_activity_at = now()
