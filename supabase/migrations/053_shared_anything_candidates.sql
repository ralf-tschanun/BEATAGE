-- Shared Anything candidates: one candidate row for all questions (question_id null).
-- Ballots stay per question; eligible pool = question-scoped OR shared (null).
...
begin
  ...
  -- Prefer question-scoped candidates; otherwise use shared pool (question_id null).
