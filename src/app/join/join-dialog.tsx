...
export function JoinDialog({ invalidCode = false }: JoinDialogProps) {
  const router = useRouter();
  const [code, setCode] = useState("");
  const [showInvalid, setShowInvalid] = useState(invalidCode);
            ...
            <div className="space-y-2">
              ...
              {showInvalid ? (
                <p className="text-sm text-destructive" role="alert">
                  No quiz found for that invite code. Check the code and try again.
                </p>
              ) : (
